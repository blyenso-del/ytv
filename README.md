...
- **[ytv_v0.3.apk](https://github.com/blyenso-del/ytv/releases/download/v0.3/ytv_v0.3.apk)**
- 发布页：https://github.com/blyenso-del/ytv/releases/tag/v0.3

## 安装

```bash
adb uninstall com.blyen.ytv   # 签名不一致时需先卸载
adb push ytv_v0.3.apk /data/local/tmp/ytv_release.apk
